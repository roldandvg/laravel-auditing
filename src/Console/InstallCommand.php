...
namespace Roldandvg\Auditing\Console;
...
class InstallCommand extends Command
{
    ...
    protected function registerAuditingServiceProvider()
    {
        ...
        if (Str::contains($appConfig, 'Roldandvg\\Auditing\\AuditingServiceProvider::class')) {
            return;
        }

        file_put_contents(config_path('app.php'), str_replace(
            "{$namespace}\\Providers\EventServiceProvider::class,".PHP_EOL,
            "{$namespace}\\Providers\EventServiceProvider::class,".PHP_EOL."        Roldandvg\Auditing\AuditingServiceProvider::class,".PHP_EOL,
            $appConfig
        ));
    }
}
